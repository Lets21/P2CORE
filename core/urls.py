...
urlpatterns = [
    ...
    path('registrar_sintomas/<int:paciente_id>/', views.registrar_sintomas, name='registrar_sintomas'),
    path('registrar_sintomas_general/', views.registrar_sintomas_general, name='registrar_sintomas_general'),
